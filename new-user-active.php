...
<?php
    ...
    $qury = "SELECT name,mobile FROM new_user_active";
    $mobile = array();
    echo '  
        <!doctype html>
        <html lang="en">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
              <form action="details-new-user-active.php" method="post"><br>
                <div class="form-group pt-3 mb-1">
                    <label for="name" class="mb-0"><b>Name</b><span class="text-danger">*</span></label>
                    <select name="name" id="name" class="form-control" title="Select Name" onchange="select_mobile()" required>
