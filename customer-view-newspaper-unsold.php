<?php
    ...
    $mobile = $_POST['mobile'];
    $qury = "SELECT newspaper_name FROM unsold_daily_basis_newspaper WHERE customer_name = '".$name."' and mobile = '".$mobile."' and date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-newspaper'] = "You do not have any Unsold Newspaper on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View Newspaper Unsold</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View Newspaper Unsold</h2>
            </div><br><br>
            ';
            $name = $_POST['customername'];
            $mobile = $_POST['mobile'];
            $qury = "SELECT * FROM unsold_daily_basis_newspaper WHERE customer_name = '".$name."' and mobile = '".$mobile."' and date = '".$date."'";
            echo '
