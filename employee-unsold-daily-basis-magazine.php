<?php  
    ...
    echo '
        ...
        <head>
            ...
            <title>Unsold Daily Basis Magazine</title>
        ...
        <br><br>
            ...
            <div class="text-center">
                <h2 class="text-danger">Unsold Daily Basis Magazine</h2>
            </div>
            <div class="text-danger ml-4">
                <p>Mandatory fields are marked with an asterisk(*)</p>
            </div>

            <form action="employee-input-unsold-daily-basis-magazine.php" method="post">
