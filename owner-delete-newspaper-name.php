<?php
    ...
    echo '
        ...
        <head>
            ...
            <title>Delete Newspaper Details</title>
        ...
        <div class="text-center">
            <h2 class="text-danger">Delete Newspaper Details</h2>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
              <form action="owner-forever-delete-newspaper-name.php" method="post"><br>
                <div class="form-group pt-3 mb-1">
                    <label for="papername" class="mb-0"><b>Newspaper Name</b><span class="text-danger">*</span></label>
                    <select name="papername" id="papername" class="form-control" title="Select Newspaper Name" required>
