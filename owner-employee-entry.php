<?php
    echo '
        ...
        <div class="text-center">
            <h2 class="text-danger">Employee Entry</h2>
        </div>
        ...
        <form action="owner-input-employee.php" method="post">
            <div class="row mx-5 p-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                ...
                <div class="col-lg-3 col-md-3 pt-3 mb-1">
                    <label for="jobrole"><b>Job Role</b><span class="text-danger">*</span></label>
                    <input type="text" name="jobrole" id="jobrole" class="form-control" title="Enter Job Role" placeholder="Enter Job Role" maxlength="100" onkeyup="lettersonly(this)" required>
                </div>
                <div class="col-lg-2 col-md-2 pt-3 mb-1">
                    <label for="salary"><b>Salary</b><span class="text-danger">*</span></label>
                    <input type="text" name="salary" id="salary" class="form-control" title="Enter Salary" placeholder="Enter Salary" maxlength="100" onkeyup="numberonly(this)" required>
                </div>
