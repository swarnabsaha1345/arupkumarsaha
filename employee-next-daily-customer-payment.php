<?php 
    ...
    $qury = "SELECT bill,payment,due FROM daily_bill WHERE date = '".$pdate."' and customer_name = '".$name."' and mobile = '".$mobile."'";
    $bill = 0;
    $payment = 0;
    $due = 0;
    ...
    echo '
        ...
        <br><br>
            ...
            <form action="employee-input-next-daily-customer-payment.php" method="post">
