<?php
    ...
    echo '
        ...
        <head>
            ...
            <title>Delete Today Total Collection</title>
        ...
        <div class="text-center">
            <h2 class="text-danger">Delete Today Total Collection</h2>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
              <form action="owner-forever-delete-today-total-collection.php" method="post"><br>
