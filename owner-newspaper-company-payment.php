<?php  
    ...
    $qury = "SELECT newspaper_name FROM newspaper_entry";
    echo '
        <!doctype html>
        <html lang="en">
        ...
        <head>
            ...
            <title>Newspaper Company Payment</title>
        ...
        <br><br>
            ...
            <div class="text-center">
                <h2 class="text-danger">Newspaper Company Payment</h2>
            </div>
            <div class="text-danger ml-4 text-center">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                    <form action="owner-input-newspaper-company-payment.php" method="post">
                    <div class="form-group pt-3 mb-1">
                        <label for="date" class="mb-0"><b>Payment Date</b><span class="text-danger">*</span></label>
                        <input type="date" name="date" id="date" class="form-control" placeholder="Select Date"
                            title="Select Date" required>
                    </div>
                    <div class="form-group pt-3 mb-1">
                    <label for="year" class="mb-0"><b>Year</b><span class="text-danger">*</span></label>
                    <input type="text" name="year" id="year" class="form-control" placeholder="Enter Year"
                        title="Enter Year" onkeyup="numberonly(this)" maxlength="4" required>
                    </div>
                    <div class="form-group pt-3 mb-1">
                        <label for="month" class="mb-0"><b>Month</b><span class="text-danger">*</span></label>
                        <select name="month" id="month" title="Select Month" class="form-control" required>
                    ...
                    <div class="form-group pt-3 mb-1">
                        ...
                        <select name="papername" id="papername" class="form-control" title="Select Magazine Name" required>
                        <option value="" disabled selected>Select</option>';
