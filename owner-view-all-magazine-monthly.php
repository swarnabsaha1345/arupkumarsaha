<?php
    ...
    $qury = "SELECT magazine_name FROM monthly_basis_magazine WHERE magazine_name = '".$magazine_name."' and date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-magazine'] = "There are no Magazine entry on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View All Magazine All Monthly</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View All Magazine Monthly</h2>
            </div><br><br>
            ';
            $magazine_name = $_POST['magazinename'];
            $qury = "SELECT * FROM monthly_basis_magazine WHERE magazine_name = '".$magazine_name."' and date = '".$date."'";
            echo '
