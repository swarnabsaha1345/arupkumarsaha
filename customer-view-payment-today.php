<?php
    ...
    $mobile = $_POST['mobile'];
    $qury = "SELECT purchase_date FROM daily_customer_payment WHERE customer_name = '".$name."' and mobile = '".$mobile."' and purchase_date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-payment'] = "You do not have any Payment for purchased on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View Payment Today</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View Payment Today</h2>
            </div><br><br>
            ';
            $name = $_POST['customername'];
            $mobile = $_POST['mobile'];
            $qury = "SELECT * FROM daily_customer_payment WHERE customer_name = '".$name."' and mobile = '".$mobile."' and purchase_date = '".$date."'";
            echo '
