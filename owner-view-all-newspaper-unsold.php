<?php
    ...
    $date = $_POST['date'];
    $qury = "SELECT newspaper_name FROM unsold_daily_basis_newspaper WHERE date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-newspaper'] = "There are no Unsold Newspaper entry on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View All Newspaper Unsold</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View All Newspaper Unsold</h2>
            </div><br><br>
            ';
            $qury = "SELECT * FROM unsold_daily_basis_newspaper WHERE date = '".$date."'";
            echo '
