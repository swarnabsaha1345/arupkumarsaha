<?php
    ...
    $mobile = $_POST['mobile'];
    $qury = "SELECT magazine_name FROM unsold_daily_basis_magazine WHERE customer_name = '".$name."' and mobile = '".$mobile."' and date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-magazine'] = "You do not have any Unsold Magazine on ".$date.".";
    ...
    function display($date){
        ...
        <body>
            ...
            $name = $_POST['customername'];
            $mobile = $_POST['mobile'];
            $qury = "SELECT * FROM unsold_daily_basis_magazine WHERE customer_name = '".$name."' and mobile = '".$mobile."' and date = '".$date."'";
            echo '
