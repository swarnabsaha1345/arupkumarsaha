<?php  
    ...
    $qury1 = "SELECT newspaper_name,regular_price,sunday_price FROM newspaper_entry";
    $mobile = array();
    $regular_price = array();
    $sunday_price = array();
    echo '
        ...
        <head>
            ...
            <title>Unsold Daily Basis Newspaper</title>
        ...
        <br><br>
            ...
            <div class="text-center">
                <h2 class="text-danger">Unsold Daily Basis Newspaper</h2>
            </div>
            <div class="text-danger ml-4">
                <p>Mandatory fields are marked with an asterisk(*)</p>
            </div>

            <form action="employee-input-unsold-daily-basis-newspaper.php" method="post">
                <div class="row mx-5 p-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                    ...
                    <div class="col-lg-2 col-md-4 pt-3 mb-1">
                        ...
                        <input type="number" name="quentity" id="quentity" class="form-control"
                            placeholder="Enter Newspaper Quentity" title="Enter Newspaper Quentity" onkeyup="total_amount()" required>
                    </div>
                    <div class="col-lg-2 col-md-4 pt-3 mb-1">
                        <label for="price" class="mb-0"><b>Newspaper Price</b><span class="text-danger">*</span></label>
                        <input type="text" name="price" id="price" class="form-control" placeholder="Enter Newspaper Price"
                            title="Enter Newspaper Price" onkeyup="total_amount()" readonly required>
                    </div>
                    <div class="col-lg-2 col-md-4 pt-3 mb-1">
