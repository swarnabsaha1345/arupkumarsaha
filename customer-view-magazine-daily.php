<?php
    ...
    $qury = "SELECT magazine_name FROM daily_basis_magazine WHERE customer_name = '".$name."' and mobile = '".$mobile."' and magazine_name = '".$magazine_name."' and date = '".$date."'";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View Magazine Daily</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View Magazine Daily</h2>
            </div><br><br>
            ';
            $name = $_POST['customername'];
            $magazine_name = $_POST['magazinename'];
            $mobile = $_POST['mobile'];
            $qury = "SELECT * FROM daily_basis_magazine WHERE customer_name = '".$name."' and mobile = '".$mobile."' and magazine_name = '".$magazine_name."' and date = '".$date."'";
            echo '
