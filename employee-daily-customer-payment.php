<?php  
    ...
    echo '
        ...
        <head>
            ...
            <title>Daily Customer Payment</title>
        ...
        <br><br>
            ...
            <div class="text-center">
                <h2 class="text-danger">Daily Customer Payment</h2>
            </div>
            <div class="text-danger text-center ml-4">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                <form action="employee-input-daily-customer-payment.php" method="post">
                ...
                <div class="form-group pt-3 mb-1">
                    <label for="pdate" class="mb-0"><b>Purchase Date</b><span class="text-danger">*</span></label>
                    <input type="date" name="pdate" id="pdate" class="form-control" placeholder="Select Purchase Date"
                        title="Select Purchase Date" required>
                </div>
                <div class="form-group pt-3 mb-1">
                    <label for="name" class="mb-0"><b>Customer Name</b><span class="text-danger">*</span></label>
                    <select name="name" id="name" class="form-control" title="Select Customer Name" onchange="select_mobile()" required>
              ...
              <script>
                ...
                function select_mobile(){
                    document.getElementById("mobile").value = mobile[document.getElementById("name").selectedIndex-1];
                }
