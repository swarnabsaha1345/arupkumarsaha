<?php
    ...
    echo '
        ...
        <head>
            ...
            <title>Update Customer Mobile Number</title>
        ...
        <div class="text-center">
            <h2 class="text-danger">Update Customer Mobile Number</h2>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                <form action="owner-input-update-customer-mobile-number.php" method="post"><br>
        ...
        echo '
                ...
                <div class="form-group pt-3 mb-1">
                    <label for="mobile" class="mb-0"><b>Mobile Number</b><span class="text-danger">*</span></label>
                    <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Enter Mobile Number"
                    title="Enter Mobile Number" readonly>
                </div>
                  <div class="form-group pt-3 mb-1">
