<?php
    ...
    $date = $_POST['date'];
    $qury = "SELECT purchase_date FROM daily_customer_payment WHERE purchase_date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-payment'] = "There are no Payment entry on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View All Payment Today</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View All Payment Today</h2>
            </div><br><br>
            ';
            $qury = "SELECT * FROM daily_customer_payment WHERE purchase_date = '".$date."'";
            echo '
