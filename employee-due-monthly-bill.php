<?php
    ...
    echo '
        ...
        <head>
            ...
            <title>View Due Monthly Bill</title>
        ...
        <div class="text-center">
            <h2 class="text-danger">View Due Monthly Bill</h2>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
              <form action="employee-view-due-monthly-bill.php" method="post"><br>
        ...
        echo '
                ...
                <div class="form-group pt-3 mb-1">
                    ...
                    <select name="month" id="month" class="form-control" title="Select Month" required>
                        <option value="" disabled selected>Select</option>
