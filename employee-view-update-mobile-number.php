        ...
        if(mysqli_num_rows($result)>0){
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <div class="text-center">
                    <h2 class="text-danger">Update Mobile Number</h2>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                        <form action="employee-input-update-mobile-number.php" method="post"><br>
                        <div class="form-group pt-3 mb-1">
                            <label for="oldmobile" class="mb-0"><b>Old Mobile Number</b><span class="text-danger">*</span></label>
                            <input type="text" name="oldmobile" id="oldmobile" class="form-control"  value="'.$mobile.'" readonly>
                        </div>
                        <div class="form-group pt-3 mb-1">
                            <label for="newmobile" class="mb-0"><b>New Mobile Number</b><span class="text-danger">*</span></label>
                            <input type="text" name="newmobile" id="newmobile" class="form-control" placeholder="New Mobile Number"
                                title="New Mobile Number" onkeyup="check()" onkeypress="numberonly(this)" maxlength="10" required>
