<?php
    ...
    $qury = "SELECT newspaper_name FROM daily_basis_newspaper WHERE newspaper_name = '".$newspaper_name."' and date = '".$date."'";
    ...
    function display($date){
        ...
        <body>
            ...
            ';
            $newspaper_name = $_POST['papername'];
            $qury = "SELECT * FROM daily_basis_newspaper WHERE newspaper_name = '".$newspaper_name."' and date = '".$date."'";
            echo '
