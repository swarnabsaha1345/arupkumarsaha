<?php
    ...
    $qury = "SELECT newspaper_name FROM monthly_basis_newspaper WHERE customer_name = '".$name."' and mobile = '".$mobile."' and newspaper_name = '".$newspaper_name."' and date = '".$date."'";
    ...
    function display($date){
        ...
        <body>
            ...
            $name = $_POST['customername'];
            $mobile = $_POST['mobile'];
            $qury = "SELECT * FROM monthly_basis_newspaper WHERE customer_name = '".$name."' and mobile = '".$mobile."' and newspaper_name = '".$newspaper_name."' and date = '".$date."'";
            echo '
