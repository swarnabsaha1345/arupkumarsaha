<?php
    ...
    $qury = "SELECT name,mobile FROM employee_entry";
    $mobile = array();
    echo '
        <!doctype html>
        <html lang="en">
        ...
        <head>
            ...
            <title>Employee Details Check</title>
        ...
        <div class="text-center">
            <h2 class="text-danger">Employee Details Check</h2>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
              <form action="owner-view-details-employee-name.php" method="post"><br>
                <div class="form-group pt-3 mb-1">
                    <label for="employeename" class="mb-0"><b>Employee Name</b><span class="text-danger">*</span></label>
                    <select name="employeename" id="employeename" class="form-control" title="Select Employee Name" onchange="select_mobile()" required>
        ...
        <script>
            ...
            function select_mobile(){
                document.getElementById("mobile").value = mobile[document.getElementById("employeename").selectedIndex-1];
            }
        </script>
