<?php
    ...
    $qury = "SELECT magazine_name FROM daily_basis_magazine WHERE magazine_name = '".$magazine_name."' and date = '".$date."'";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View All Magazine Daily</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View All Magazine Daily</h2>
            </div><br><br>
            ';
            $magazine_name = $_POST['magazinename'];
            $qury = "SELECT * FROM daily_basis_magazine WHERE magazine_name = '".$magazine_name."' and date = '".$date."'";
            echo '
