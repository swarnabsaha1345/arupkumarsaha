<?php  
    ...
    $name = $_POST['name'];
    $mobile = $_POST['mobile'];
    $qury = "SELECT name FROM new_user_active WHERE name = '".$name."' and mobile = '".$mobile."'";
    ...
    function display($name,$mobile){
        require_once 'database-connection.php';
        $mysqli = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_DATABASE);
        $qury = "SELECT * FROM new_user_active WHERE name = '".$name."' and mobile = '".$mobile."'";
        if($result = $mysqli->query($qury)){
            if(mysqli_num_rows($result)>0){
                ...
                echo '
                    ...
                    <body>
                        ...
                        <a class="dropdown-item" href="view-all-monthly-customer-payment.php">View All Monthly Customer Payment</a>    
                            ...
                            <li class="nav-item">
                            <a class="nav-link active" href="new-user-active.php">New Users Active</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="text-center">
                            <h2 class="text-danger">New Users Active</h2>
                        </div><br><br>
            
                    <form action="input-details-new-user-active.php" method="post">
                        <div class="row mx-5 p-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                            ...
                            <input type="text" name="town" id="town" class="form-control text-capitalize" value="'.$row['town'].'" readonly>
                            </div>
                            ...
                            <input type="text" name="password" id="password" class="form-control" value="'.$row['password'].'" readonly>
                            </div>
                            <div class="col-lg-4 col-md-4 pt-3 mb-1">
                            <label for="position" class="mb-0"><b>Position</b><span class="text-danger">*</span></label>
                            <select name="position" id="position" class="form-control" title="Select position" required>
