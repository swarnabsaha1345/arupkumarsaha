<?php
    ...
    $qury = "SELECT magazine_name FROM monthly_basis_magazine WHERE customer_name = '".$name."' and mobile = '".$mobile."' and magazine_name = '".$magazine_name."' and date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
           ...
           // session_unset();
            ...
            $_SESSION['no-magazine'] = "You do not have any Magazine on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View Magazine Monthly</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View Magazine Monthly</h2>
            </div><br><br>
            ';
            $magazine_name = $_POST['magazinename'];
            $name = $_POST['customername'];
            $mobile = $_POST['mobile'];
            $qury = "SELECT * FROM monthly_basis_magazine WHERE customer_name = '".$name."' and mobile = '".$mobile."' and magazine_name = '".$magazine_name."' and date = '".$date."'";
            echo '
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td scope="col">'.$magazine_price.'</td>
