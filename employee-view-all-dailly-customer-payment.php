<?php  
    ...
    echo '
        ...
        <head>
            ...
            <title>View Daily Customer Payment</title>
        ...
        <br><br>
            ...
            <div class="text-center">
                <h2 class="text-danger">View Daily Customer Payment</h2>
            </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 col-md-6 mx-3" style="background-color: rgb(255, 187, 0); border-radius: 25px;">
                <form action="employee-details-view-all-dailly-customer-payment.php" method="post">
