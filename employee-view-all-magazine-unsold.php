<?php
    ...
    $date = $_POST['date'];
    $qury = "SELECT magazine_name FROM unsold_daily_basis_magazine WHERE date = '".$date."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-magazine'] = "There are no Unsold Magazine entry on ".$date.".";
    ...
    function display($date){
        ...
        <head>
            ...
            <title>View All Magazine Unsold</title>
        ...
        <body>
            ...
            <div class="text-center">
                <h2 class="text-danger">View All Magazine Unsold</h2>
            </div><br><br>
            ';
            $qury = "SELECT * FROM unsold_daily_basis_magazine WHERE date = '".$date."'";
            echo '
