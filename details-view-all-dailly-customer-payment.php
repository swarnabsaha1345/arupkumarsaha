<?php
    ...
    $name = $_POST['name'];
    $mobile = $_POST['mobile'];
    $qury = "SELECT * FROM daily_customer_payment WHERE payment_date = '".$date."' and customer_name = '".$name."' and mobile = '".$mobile."'";
    if($result = $mysqli->query($qury)){
        if(mysqli_num_rows($result)>0){
            ...
            $_SESSION['no-details'] = "There are no Customer payment on ".$date.".";
