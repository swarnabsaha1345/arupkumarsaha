<?php
    ...
    $qury = "SELECT magazine_name,magazine_price FROM magazine_entry";
    $price = array();
    echo '
        <!doctype html>
        <html lang="en">
        ...
        <head>
            ...
            <title>Today Total Magazine</title>
        ...
        <br><br>
            ...
            <div class="text-center">
                <h2 class="text-danger">Today Total Magazine</h2>
            </div>
            <div class="text-danger ml-4">
                <p>Mandatory fields are marked with an asterisk(*)</p>
            </div>

            <form action="employee-input-today-total-magazine.php" method="post">
